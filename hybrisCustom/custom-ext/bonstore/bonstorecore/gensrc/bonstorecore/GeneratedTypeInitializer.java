...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"ApparelProduct",
			"Product",
			org.bonstore.core.jalo.ApparelProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			org.bonstore.core.jalo.ApparelStyleVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"ApparelStyleVariantProduct",
			org.bonstore.core.jalo.ApparelSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			org.bonstore.core.jalo.ElectronicsColorVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"Organization",
			"GenericItem",
			org.bonstore.core.jalo.Organization.class,
			"de.hybris.platform.persistence.bonstorecore_Organization",
			false,
			null,
			false
		);
		...
		createRelationType(
			"CustomerOrganizationRelation",
			"de.hybris.platform.persistence.link.bonstorecore_CustomerOrganizationRelation",
			false
		);
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		single_setRelAttributeProperties_CustomerOrganizationRelation_source();
	
		single_setRelAttributeProperties_CustomerOrganizationRelation_target();
					...
					null
						...
						public void single_setAttributeProperties_Organization_email() throws JaloBusinessException
						{
							...
							setAttributeProperties(
								...
								public void single_setRelAttributeProperties_CustomerOrganizationRelation_source() throws JaloBusinessException
								{
								...
								public void single_setRelAttributeProperties_CustomerOrganizationRelation_target() throws JaloBusinessException
								{
